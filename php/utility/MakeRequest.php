...
// StephenKing SDK utility: make_request

require_once __DIR__ . '/../core/Response.php';
require_once __DIR__ . '/../core/Result.php';

class StephenKingMakeRequest
{
    public static function call(StephenKingContext $ctx): array
    {
        ...
        if ($fetch_err) {
            ...
            $response = new StephenKingResponse(['err' => $ctx->make_error('request_no_response', 'response: undefined')]);
        } elseif (is_array($fetched)) {
            $response = new StephenKingResponse($fetched);
        } else {
