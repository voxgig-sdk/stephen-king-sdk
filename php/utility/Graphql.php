...
// StephenKing SDK utility: graphql
//
...
class StephenKingGraphql
{
    ...
    // equivalent.
    public static function body(StephenKingContext $ctx): mixed
    {
    ...
    public static function errors(StephenKingContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
