...
// StephenKing SDK utility: transform_response

require_once __DIR__ . '/../core/Helpers.php';

class StephenKingTransformResponse
{
    public static function call(StephenKingContext $ctx): mixed
    {
        ...
        $transform = StephenKingHelpers::to_map(\Voxgig\Struct\Struct::getprop($point, 'transform'));
        if (!$transform) {
            return null;
        }
