...
// StephenKing SDK utility: fetcher

class StephenKingFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; StephenKingSDK/1.0)';
    ...
    public static function call(StephenKingContext $ctx, string $fullurl, array $fetchdef): array
    {
