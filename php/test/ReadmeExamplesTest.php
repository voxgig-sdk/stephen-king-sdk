...
// StephenKing SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (StephenKingSDK::test)
...
{
    private const SDK_CLASS = 'StephenKingSDK';
    ...
    private const SDK_BASE = 'stephenking_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../stephenking_sdk.php';
        foreach ($this->phpBlocks() as $blk) {
