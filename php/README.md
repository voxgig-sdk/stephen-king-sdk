...
The PHP SDK for the StephenKing API. Provides an entity-oriented interface using PHP conventions.
...
[$result, $err] = $client->StephenKing(null)->load(
    ["id" => "test01"], null
);
...
```
php/
├── stephenking_sdk.php          -- Main SDK class
...
The main class (`stephenking_sdk.php`) exports the SDK class
