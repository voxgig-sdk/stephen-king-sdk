...
// StephenKing SDK metrics feature
...
class StephenKingMetricsFeature extends StephenKingBaseFeature
{
    ...
    private function _record(StephenKingContext $ctx, bool $ok): void
    {
