...
// StephenKing SDK ratelimit feature
...
class StephenKingRatelimitFeature extends StephenKingBaseFeature
{
    ...
    private function _acquire(StephenKingContext $ctx): void
    {
    ...
    private function _track(StephenKingContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
