...
// StephenKing SDK telemetry feature
...
class StephenKingTelemetryFeature extends StephenKingBaseFeature
{
    ...
    private function _close(StephenKingContext $ctx, bool $ok): void
    {
