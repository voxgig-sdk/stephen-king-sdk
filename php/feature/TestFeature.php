...
// StephenKing SDK test feature

require_once __DIR__ . '/BaseFeature.php';
require_once __DIR__ . '/../utility/Param.php';

class StephenKingTestFeature extends StephenKingBaseFeature
{
    ...
    public function init(StephenKingContext $ctx, array $options): void
    {
        ...
        $test_fetcher = function (StephenKingContext $fctx, string $_fullurl, array $_fetchdef) use ($entity): array {
            ...
            if ($op->name === 'load') {
                ...
                $id = StephenKingParam::call($fctx, 'id');
    ...
    public function makeNetsim(array $net, callable $inner): callable
    {
        ...
        return function (StephenKingContext $fctx, string $url, array $fetchdef) use ($net, $inner, $pick_latency, $sleep): array {
            $this->_netcalls++;
            $call = $this->_netcalls;
     ...
     */
    public function buildArgs(StephenKingContext $ctx, $op, $args): array
    {
