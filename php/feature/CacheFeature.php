...
class StephenKingCacheFeature extends StephenKingBaseFeature
{
    ...
    private function _through(StephenKingContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
