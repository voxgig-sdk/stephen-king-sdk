...
describe('ShortEntity', async () => {
  ...
  test('basic', async (t) => {
    ...
    for (const op of ['list', 'load']) {
      if (maybeSkipControl(t, 'entityOp', 'short.' + op, live)) return
    }
    ...
    let short_ref01_data = Object.values(setup.data.existing.short)[0] as any
...
function basicSetup(extra?: any) {
  ...
  const entityDataFile =
    Path.resolve(__dirname, 
      '../../../../.sdk/test/entity/short/ShortTestData.json')
