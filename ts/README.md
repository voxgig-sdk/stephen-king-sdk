...
The TypeScript SDK for the StephenKing API. Provides a type-safe, entity-oriented interface with full async/await support.
...
```ts
const client = new StephenKingSDK({ apikey: '...' })
