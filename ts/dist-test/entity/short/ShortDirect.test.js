...
(0, node_test_1.describe)('ShortDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-short', async (t) => {
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-short', setup.live))
            return;
    ...
    (0, node_test_1.test)('direct-list-short', async (t) => {
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-short', setup.live))
            return;
        const { client, calls } = setup;
        const params = {};
        const query = {};
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['STEPHEN_KING_TEST_SHORT_ENTID'];
...
//# sourceMappingURL=ShortDirect.test.js.map