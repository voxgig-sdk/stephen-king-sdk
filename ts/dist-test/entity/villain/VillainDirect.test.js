...
(0, node_test_1.describe)('VillainDirect', async () => {
    ...
    (0, node_test_1.test)('direct-exists', async () => {
        const sdk = new __1.StephenKingSDK({
    ...
    (0, node_test_1.test)('direct-load-villain', async (t) => {
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-villain', setup.live))
            return;
    ...
    (0, node_test_1.test)('direct-list-villain', async (t) => {
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-villain', setup.live))
            return;
        const { client, calls } = setup;
        const params = {};
        const query = {};
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        const client = new __1.StephenKingSDK(Object.assign({}, (0, utility_1.liveClientOptions)(), {}));
        let idmap = env['STEPHEN_KING_TEST_VILLAIN_ENTID'];
    ...
    const client = new __1.StephenKingSDK({
        base: 'http://localhost:8080',
...
//# sourceMappingURL=VillainDirect.test.js.map