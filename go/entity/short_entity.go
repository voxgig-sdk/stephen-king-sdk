...
func NewShortEntity(client *core.StephenKingSDK, entopts map[string]any) *ShortEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *ShortEntity) GetName() string { return e.name }
...
func (e *ShortEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *ShortEntity) Deleted() bool {
	return e.deleted
}


func (e *ShortEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewShortEntity(e.client, opts)
}

func (e *ShortEntity) Data(args ...any) any {
...
func (e *ShortEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Short; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *ShortEntity) DataTyped(data ...Short) Short {
	if len(data) > 0 {
		return typedFrom[Short](e.Data(asMap(data[0])))
	}
	return typedFrom[Short](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Short (all fields
// optional at the wire level).
func (e *ShortEntity) MatchTyped(match ...Short) Short {
	if len(match) > 0 {
		return typedFrom[Short](e.Match(asMap(match[0])))
	}
	return typedFrom[Short](e.Match())
}
...
func (e *ShortEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *ShortEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// ShortLoadMatch and returns an Short. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *ShortEntity) LoadTyped(reqmatch ShortLoadMatch, ctrl map[string]any) (Short, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return Short{}, err
	}
	return typedFrom[Short](res), nil
}




func (e *ShortEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":   "list",
		"ctrl":     ctrl,
...
// ShortListMatch and returns []Short. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *ShortEntity) ListTyped(reqmatch ShortListMatch, ctrl map[string]any) ([]Short, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[Short](res), nil
}



func (e *ShortEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *ShortEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *ShortEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *ShortEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
