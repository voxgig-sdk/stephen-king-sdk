...
import (
	...
	vs "github.com/voxgig-sdk/stephen-king-sdk/go/utility/struct"
)

type VillainEntity struct {
	name    string
	client  *core.StephenKingSDK
...
func NewVillainEntity(client *core.StephenKingSDK, entopts map[string]any) *VillainEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *VillainEntity) GetName() string { return e.name }
...
func (e *VillainEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *VillainEntity) Deleted() bool {
	return e.deleted
}


func (e *VillainEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewVillainEntity(e.client, opts)
}

func (e *VillainEntity) Data(args ...any) any {
...
func (e *VillainEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Villain; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *VillainEntity) DataTyped(data ...Villain) Villain {
	if len(data) > 0 {
		return typedFrom[Villain](e.Data(asMap(data[0])))
	}
	return typedFrom[Villain](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Villain (all fields
// optional at the wire level).
func (e *VillainEntity) MatchTyped(match ...Villain) Villain {
	if len(match) > 0 {
		return typedFrom[Villain](e.Match(asMap(match[0])))
	}
	return typedFrom[Villain](e.Match())
}
...
func (e *VillainEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *VillainEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// VillainLoadMatch and returns an Villain. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *VillainEntity) LoadTyped(reqmatch VillainLoadMatch, ctrl map[string]any) (Villain, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return Villain{}, err
	}
	return typedFrom[Villain](res), nil
}




func (e *VillainEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":   "list",
		"ctrl":     ctrl,
...
// VillainListMatch and returns []Villain. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *VillainEntity) ListTyped(reqmatch VillainListMatch, ctrl map[string]any) ([]Villain, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[Villain](res), nil
}



func (e *VillainEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *VillainEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *VillainEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *VillainEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
