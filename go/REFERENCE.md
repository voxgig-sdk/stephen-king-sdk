# StephenKing Golang SDK Reference

Complete API reference for the StephenKing Golang SDK.
...
#### `TestSDK(testopts, sdkopts map[string]any) *StephenKingSDK`
...
#### `Book(data map[string]any) StephenKingEntity`

Create a new `Book` entity instance. Pass `nil` for no initial data.

#### `Short(data map[string]any) StephenKingEntity`

Create a new `Short` entity instance. Pass `nil` for no initial data.

#### `Villain(data map[string]any) StephenKingEntity`
