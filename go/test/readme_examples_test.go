...
const testSeed = `map[string]any{"entity": map[string]any{"book": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "short": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "villain": map[string]any{"example_id": map[string]any{"id": "example_id"}}}}`
