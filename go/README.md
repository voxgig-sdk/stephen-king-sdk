...
The Golang SDK for the StephenKing API. Provides an entity-oriented interface using standard Go conventions — no generics required, data flows as `map[string]any`.


## Install
```bash
go get github.com/voxgig-sdk/stephen-king-sdk
```
...
```bash
go mod edit -replace github.com/voxgig-sdk/stephen-king-sdk=../path/to/github.com/voxgig-sdk/stephen-king-sdk
```
...
```
github.com/voxgig-sdk/stephen-king-sdk/
...
The root package (`github.com/voxgig-sdk/stephen-king-sdk`) re-exports everything needed
