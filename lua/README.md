...
The Lua SDK for the StephenKing API — an entity-oriented client using Lua conventions.
...
GitHub release tag (`lua/vX.Y.Z`, see [Releases](https://github.com/voxgig-sdk/stephen-king-sdk/releases)),
...
```
lua/
├── stephen-king_sdk.lua    -- Main SDK module
...
The main module (`stephen-king_sdk`) exports the SDK constructor
