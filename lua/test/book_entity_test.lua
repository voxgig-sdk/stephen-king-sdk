...
describe("BookEntity", function()
  ...
  it("should run basic flow", function()
    ...
    if setup.synthetic_only then
      pending("live entity test uses synthetic IDs from fixture — set STEPHEN_KING_TEST_BOOK_ENTID JSON to run live")
      return
    end
...
function book_basic_setup(extra)
  ...
  local entid_env_raw = os.getenv("STEPHEN_KING_TEST_BOOK_ENTID")
