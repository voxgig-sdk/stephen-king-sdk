...
function runner.env_override(m)
  local live = runner.getenv("STEPHENKING_TEST_LIVE")
  local override = runner.getenv("STEPHENKING_TEST_OVERRIDE")
  ...
  local explain = runner.getenv("STEPHENKING_TEST_EXPLAIN")
