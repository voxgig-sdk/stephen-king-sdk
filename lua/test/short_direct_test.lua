...
describe("ShortDirect", function()
  it("should direct-list-short", function()
    local setup = short_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-short", setup.live and "live" or "unit")
  ...
  it("should direct-load-short", function()
    local setup = short_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-short", setup.live and "live" or "unit")
    if _should_skip then
      pending(_reason or "skipped via sdk-test-control.json")
      return
    end
...
function short_direct_setup(mockres)
