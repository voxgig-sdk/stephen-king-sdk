...
func registerSDKWords(r *eng.Registry, client *sdk.StephenKingSDK) {
...
func runOp(client *sdk.StephenKingSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
