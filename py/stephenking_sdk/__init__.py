...
from stephenking_sdk.utility import register

# Load features
from stephenking_sdk.feature.base_feature import StephenKingBaseFeature
from stephenking_sdk.features import _has_feature, _make_feature
...
class StephenKingSDK:
    ...
    def get_utility(self):
        return StephenKingUtility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("StephenKingSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def Book(self, data=None) -> "BookEntity":
        ...
        from stephenking_sdk.entity.book_entity import BookEntity
        return BookEntity(self, data)


    def Short(self, data=None) -> "ShortEntity":
        """Entity factory: client.Short().list() / client.Short().load({"id": ...})."""
        from stephenking_sdk.entity.short_entity import ShortEntity
    ...
    def Villain(self, data=None) -> "VillainEntity":
        ...
        from stephenking_sdk.entity.villain_entity import VillainEntity
