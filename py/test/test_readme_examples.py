# StephenKing SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions StephenKingSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both StephenKingSDK(...) and StephenKingSDK.test(...) become
#      StephenKingSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "stephenking_sdk"
_SDK_CLASS = "StephenKingSDK"
