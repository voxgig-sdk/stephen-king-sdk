...
class StephenKingTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = StephenKingTestRunner.getenv("STEPHENKING_TEST_LIVE")
        override = StephenKingTestRunner.getenv("STEPHENKING_TEST_OVERRIDE")
        ...
        explain = StephenKingTestRunner.getenv("STEPHENKING_TEST_EXPLAIN")
