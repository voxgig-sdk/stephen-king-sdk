...
|---|---|---|
| `ts/` | @voxgig-sdk/stephen-king-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/stephen-king-sdk \
      --repository voxgig-sdk/stephen-king-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/stephen-king-sdk` shows it, and
`npm trust revoke @voxgig-sdk/stephen-king-sdk --id=<id>` removes it.
