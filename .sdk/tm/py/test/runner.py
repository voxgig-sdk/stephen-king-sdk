...
class StephenKingTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = StephenKingTestRunner.getenv("PROJECTNAME_TEST_LIVE")
        override = StephenKingTestRunner.getenv("PROJECTNAME_TEST_OVERRIDE")
        ...
        explain = StephenKingTestRunner.getenv("PROJECTNAME_TEST_EXPLAIN")
