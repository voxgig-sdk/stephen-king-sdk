...
class StephenKingTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = StephenKingTestRunner.getenv("PROJECTENV_TEST_LIVE")
        override = StephenKingTestRunner.getenv("PROJECTENV_TEST_OVERRIDE")
        ...
        explain = StephenKingTestRunner.getenv("PROJECTENV_TEST_EXPLAIN")
