...
// StephenKing SDK timeout feature
...
class StephenKingTimeoutFeature extends StephenKingBaseFeature
{
    ...
    private function _with_timeout(StephenKingContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(StephenKingContext $_ctx, float $ms): void
    {
        $client = $this->client;
