...
// StephenKing SDK streaming feature
...
class StephenKingStreamingFeature extends StephenKingBaseFeature
{
    ...
    private function _iterate(StephenKingResult $result): \Generator
    {
    ...
    private function _streamable(StephenKingContext $ctx): bool
    {
