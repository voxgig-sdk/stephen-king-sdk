...
// StephenKing SDK clienttrack feature
...
class StephenKingClienttrackFeature extends StephenKingBaseFeature
{
    ...
    public function PostConstruct(StephenKingContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'StephenKing-SDK';
