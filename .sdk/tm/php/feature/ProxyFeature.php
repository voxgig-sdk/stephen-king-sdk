...
class StephenKingProxyFeature extends StephenKingBaseFeature
{
    ...
    public function init(StephenKingContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (StephenKingContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
