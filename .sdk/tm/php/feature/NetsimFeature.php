...
// StephenKing SDK netsim feature
...
class StephenKingNetsimFeature extends StephenKingBaseFeature
{
    ...
    private function _simulate(StephenKingContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(StephenKingContext $ctx, array $applied): void
    {
        $client = $this->client;
