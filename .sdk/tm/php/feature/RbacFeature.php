...
class StephenKingRbacFeature extends StephenKingBaseFeature
{
    ...
    private function _required(StephenKingContext $ctx): ?string
    {
    ...
    private function _reject(StephenKingContext $ctx, string $required): void
    {
    ...
    private function _track(StephenKingContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
