...
class ShortEntity
  ...
  #   as an empty match, so client.Short.load works with no args).
  ...
  #
  # @param reqmatch [ShortListMatch, Hash, nil] match filter (any subset of
  #   Short fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
