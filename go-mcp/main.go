// Command StephenKing-mcp is an MCP server exposing the StephenKing
// SDK as MCP tools.
//
// Two tools are registered:
//
//	StephenKing_list  — list records of an entity
//	StephenKing_load  — load a single record of an entity
//
