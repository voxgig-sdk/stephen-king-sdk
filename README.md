...
Provides access to Stephen King books, short stories, and villains.

Learn more about Stephen King API at [stephen-king-api.onrender.com](https://stephen-king-api.onrender.com).
...
// shorts is an array of Short entities, populated with mock data
// — call shorts[0].data() for the record itself
console.log(shorts)
```
...
```go
client := sdk.Test()
result, err := client.Short(nil).List(
    nil, nil,
)
```
...
| Go CLI | `github.com/voxgig-sdk/stephen-king-sdk/go-cli` | `go install github.com/voxgig-sdk/stephen-king-sdk/go-cli/cmd/stephen-king@latest` |
| Go MCP server | `github.com/voxgig-sdk/stephen-king-sdk/go-mcp` | `go get github.com/voxgig-sdk/stephen-king-sdk/go-mcp@latest` |
